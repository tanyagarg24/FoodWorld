...
from core.views import homepage,cart,add_to_cart,remove_from_cart,productpage,datewiseorders,handlerequest,payonline,payincash,SignUp,ownerproductpage,markdelivered,orderbutton,minus,review
...
urlpatterns = [
    ...
    path('order',orderbutton,name = 'order'),
    path('payincash',payincash,name = 'payincash'),
    path('datewiseorders',datewiseorders,name = 'datewiseorders'),
